  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-col items-center justify-center my-10 md:my-14">
        <div className="text-4xl text-PRIMARY text-center font-bold">
          Pronto
        </div>
        ...
        <a href="/login" className="mb-14 md:mb-28">
          <button className="bg-SECONDARY text-WHITE p-3 px-10 rounded-3xl text-base md:text-xl m-4 hover:scale-105 duration-200 hover:shadow-2xl">
            Fazer login
          </button>
        </a>
        {/*login-container*/}
