    ...
    return (
        <div>
            ...
            <div className='w-full flex flex-col items-center justify-center mt-10 mb-14 md:my-14'>
                <div className='text-4xl w-4/5 md:w-3/5 text-center text-PRIMARY font-bold'>Cadastro de loja</div>
                ...
                <div className='w-4/5 md:w-3/5'>
                    ...
                    <div>
                        <label className='text-base' htmlFor="">Informe o horário de funcionamento</label>
                            ...
                            {dias.map((element) => (
                                <tr className='text-GRAY_600 text-center'>
                                    ...
                                    <td className=''>
                                        ...
                                        name={`${element}HoraInicio`} id={`${element}HoraInicio`} >
                                            {hours.map((element) => (
                                    ...
                                    <td className=''>
                                        <select
                                        className='border-none bg-GRAY_300 px-2 py-1 rounded-lg mb-2' 
                                        name={`${element}HoraFim`} id={`${element}HoraFim`}>
                                            {hours.map((element) => (
                                                <option key={element} value={element}>
                                                {element}
                                                </option>
