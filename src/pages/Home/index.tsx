...
const Home = () => {
  ...
  const styleGroup = {
    squareArea3: "border-GRAY_600 border-2 w-full md:w-1/3 h-64 px-8 flex items-center justify-center",
    squareArea2: "border-GRAY_600 border-2 w-full md:w-1/2 h-64 px-8 flex items-center justify-center",
    items: "flex flex-col items-center justify-center my-10 md:my-0 w-2/3 md:w-1/5",
    button: "p-4 rounded-3xl bg-YELLOW text-xl md:text-3xl hover:scale-110 duration-200 hover:shadow-2xl"
  }
  ...
  return (
    <>
      ...
      <section id='quemsomos' className="flex flex-col items-center justify-center pt-5">
        ...
        <Animation type="fromLeft"  className="bg-SECONDARY w-full h-full flex flex-col md:flex-row items-center justify-center">
      ...
      <section className="text-center flex flex-col items-center justify-center w-full text-xl md:text-3xl">
        <div className="flex flex-col md:flex-row w-full">
          <Animation type="fromLeft" className={styleGroup.squareArea3}>Quanto mais você vender, mais você ganha!</Animation>
          <Animation type="fromBottom" className={styleGroup.squareArea3}>Plataforma de pagamento 100% segura.</Animation>
          <Animation type="fromRight" className={styleGroup.squareArea3}>Venda para toda sua região</Animation>
        </div>
        <div className="flex flex-col md:flex-row w-full">
          <Animation type="fromLeft" className={styleGroup.squareArea2}>De forma simples e rápida cadastre seus produtos e acompanhe todo histórico de vendas, lucros, avaliações dos clientes.</Animation>
          <Animation type="fromRight" className={styleGroup.squareArea2}>Chegou a hora de faturar com o seu pão, doces caseiros, lanches e até mesmo montando uma mercearia em sua casa.</Animation>
        </div>
      </section>
