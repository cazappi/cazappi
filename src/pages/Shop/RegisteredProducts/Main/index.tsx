...
const ShopManageInventoryMain = () => {
    const items = [
        { image: sanduiche, name: "Sanduiche", quantity: 2, id: 4, value: '12,00', oldPrice: '' },
        { image: sanduiche, name: "Torta", quantity: 2, id: 4, value: '12,00', oldPrice: '' },
        { image: haha, name: "Maçã", quantity: 2, id: 4, value: '12,00', oldPrice: '15,00' },
        { image: sanduiche, name: "Vitamina natural", quantity: 2, id: 4, value: '12,00', oldPrice: '' },
        { image: sanduiche, name: "Suco de laranja", quantity: 2, id: 4, value: '12,00', oldPrice: '' },
        { image: sanduiche, name: "Suco de laranja", quantity: 2, id: 4, value: '12,00', oldPrice: '' },
    ]
            ...
            <div className="flex flex-col items-center justify-center gap-4 w-full h-fit mt-8">
                ...
                <div className="flex flex-col items-start w-[80%]">
                    <div className="flex flex-row items-center justify-center text-gray-600 text-lg gap-2">
                        ...
                        <div>{">>"}</div>
                        <div className="font-bold">Produtos já cadastrados</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center h-fit w-full gap-6 my-8">
                        {
                            items.map((item, index) => {
                                return (
                                    <div key={index} className="w-full flex h-24 flex-row items-center justify-center p-2 rounded-xl shadow-xl gap-4">
                                        ...
                                        <div className="w-[90%] h-full flex flex-row items-start justify-between">
                                            <div className="flex flex-col items-start mt-1">
                                                ...
                                                <div className="flex flex-row items-center justify-center gap-2">
                                                    ...
                                                    <div className={"font-bold text-lg " + (item.oldPrice !== '' ? "text-PRIMARY" : "")}>
                                                        R$ {item.value}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-center justify-center h-full">
                                                <a href={'/ShopRegisteredProductsEdit/' + item.id} className="p-2 rounded-full border border-PRIMARY">
